        ...
        <view class="space-y-4">
          ...
          <view class="grid grid-cols-1 md-grid-cols-2 gap-4">
            ...
            <view class="flex items-center">
              ...
              <text class="flex-1 font-medium">{{ purchaseData.isPublic ? '公开' : '私密码' }}</text>
...
export default {
  ...
  methods: {
    ...
    fetchPurchaseDetail () {
      ...
      // 实际应调用API: uni.request({ url: `/api/purchase/${this.purchaseId}` })
    ...
    getPurchaseTypeText (type) {
      ...
      return type === 'long_term' ? '长期采购' : '一次性采?;
    ...
    toggleFavorite () {
      ...
      gotoChat() {
        ...
        //   url: `/pages/chat/index?purchaseId=${this.purchaseId}`,
      ...
      viewAllQuotations() {
        ...
        //   url: `/pages/purchase/quotations?id=${this.purchaseId}`,
